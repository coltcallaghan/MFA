...
def get_my_grids():
    while True:
        try:
            ...
            print("Unknown error")
            continue
        # Checks that the input was 5 digits long
        if len(str(my_grid_x)) != 5:
            print("Not a five figure X coord")
            continue
        else:
            break
    while True:
        try:
            ...
            print("Unknown error")
            continue
        if len(str(my_grid_y)) != 5:
            print("Not a five figure Y coord")
            continue
        else:
            break
